...
const Navbar = () => {
  ...
  return (
    <nav className="bg-akcess-black py-4 px-6 md:px-12 lg:px-24 sticky top-0 z-50" aria-label="Main navigation">
      <div className="flex justify-between items-center">
        ...
        <div 
          id="mobile-menu"
          className={`md:hidden absolute top-16 left-0 right-0 bg-akcess-black p-4 z-50 transition-all duration-300 ${isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        >
