...
const HeroSection = () => {
  ...
  return <section id="home" className="py-32 md:py-40 relative overflow-hidden" style={{
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Button className="lime-button text-lg py-6 px-8 rounded-md" onClick={handleContactUs}>
              Become a Client
            </Button>
            <Button variant="outline" onClick={handleConsultation} className="border-white text-lg hover:text-akcess-black py-6 px-8 rounded-md transition-all duration-300 bg-yellow-300 hover:bg-yellow-200">
